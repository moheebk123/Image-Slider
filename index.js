...
rightButton.addEventListener("click", () => {
    ...
    if (counter == 0 || counter == 1) {
        slide.setAttribute("style", `background-image: url(${images[counter+3]})`);
    } else {
        slide.setAttribute("style", `background-image: url(${images[counter - 2]})`);
    }
...
leftButton.addEventListener("click", () => {
    ...
    if (counter == 0 || counter == 1) {
        ...
        if (counter == 0) {
            slide.setAttribute("style", `background-image: url(${images[counter + 4]})`);
        } else {
            slide.setAttribute("style", `background-image: url(${images[counter - 1]})`);
        }
